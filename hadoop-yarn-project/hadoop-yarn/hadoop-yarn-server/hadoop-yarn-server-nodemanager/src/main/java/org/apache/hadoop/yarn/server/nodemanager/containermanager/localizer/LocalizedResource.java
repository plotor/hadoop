...
public class LocalizedResource implements EventHandler<ResourceEvent> {
  ...
  private static final StateMachineFactory<LocalizedResource, ResourceState,
      ...
      new StateMachineFactory<
          LocalizedResource, ResourceState,
          ResourceEventType, ResourceEvent
          >(ResourceState.INIT)
          ...
          .addTransition(
              ResourceState.INIT, ResourceState.LOCALIZED,
              ResourceEventType.RECOVERED, new RecoveredTransition()
          )

          // From DOWNLOADING (ref > 0, may be localizing)
          .addTransition( // TODO: Duplicate addition!!
              ResourceState.DOWNLOADING, ResourceState.DOWNLOADING,
              ResourceEventType.REQUEST, new FetchResourceTransition()
          )
          .addTransition(
              ResourceState.DOWNLOADING, ResourceState.LOCALIZED,
          ...
          .addTransition(
              ResourceState.LOCALIZED, ResourceState.LOCALIZED,
  ...
  public void handle(ResourceEvent event) {
    ...
    try {
      ...
      LOG.info("NEUTRON, Processing resource event {}, currentState: {}, resource: {}",
          event.getType(), oldState, resourcePath);
      ...
      if (newState != null && oldState != newState) {
        LOG.info("Resource {}{} size : {} transitioned from {} to {}",
   ...
   * {@link AbstractResourceLocalizationService}.
   */
    ...
    public void transition(LocalizedResource rsrc, ResourceEvent event) {
      ...
      for (ContainerId container : rsrc.ref) {
        final ContainerResourceLocalizedEvent localizedEvent =
            new ContainerResourceLocalizedEvent(container, rsrc.rsrc, rsrc.localPath);
