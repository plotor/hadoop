...
import org.apache.hadoop.util.TimmingTracer;
...
public class Path
  ...
  public FileSystem getFileSystem(Configuration conf) throws IOException {
    return getFileSystem(conf, new TimmingTracer());
  }
   ...
   * FileSystem
   */
  public FileSystem getFileSystem(Configuration conf, TimmingTracer ticker) throws IOException {
    return FileSystem.get(this.toUri(), conf, ticker);
  }
